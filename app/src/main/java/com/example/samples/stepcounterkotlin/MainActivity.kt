package com.example.samples.stepcounterkotlin
...
import com.example.samples.common.logger.Log
import com.example.samples.common.logger.LogView
import com.example.samples.common.logger.LogWrapper
import com.example.samples.common.logger.MessageOnlyLogFilter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun addListneres() {
        fabReadData.setOnClickListener(View.OnClickListener {
            try {
